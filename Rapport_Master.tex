...
\label{Limite}
\begin{verbatim}
%On crée un programme qui affiche les courbes de limite de la synchronisation en
...
xlabel('BPM')
ylabel('BPM')
legend('Limite inferieure de synchronisation','Battement de reference','Limite
superieure de synchroniation',4)
